...
export class DatasetManager {
  ...
  async createDumpFile() {
    ...
    await this.generateDataset(this.targetFileGraph);
    await this.generateTtlDistribution(this.targetFileGraph);
    await this.deprecatePrevious(this.targetFileGraph);
  ...
  async deprecatePrevious() {
    ...
    if(datasets.length > 1){
      ...
      `);
      await this.deprecateDistributions(previousDataset);
    }
  }
