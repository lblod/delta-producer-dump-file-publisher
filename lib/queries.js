...
export async function countResourcesInGraph(graph, publicationEndpoint) {
  console.log(`Hitting publicationEndpoint ${publicationEndpoint}`);
...
export async function getBatchedTriples(offset, graph, publicationEndpoint) {
  console.log(`Hitting publicationEndpoint ${publicationEndpoint}`);
  const q = `
  ...
  const queryResult = await query(q, {}, publicationEndpoint);
